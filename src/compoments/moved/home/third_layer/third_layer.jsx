  ...
  return (
    <div className='home_third_layer'>
      ...
      <div className="groups revers" onClick={handleLogoClick}>
        <p>Wyatt est le moteur de ce projet, actuellement étudiant en audiovisuel, il a choisi de s&apos;éxercer dans le dur pour faire ce qu&apos;il aime avec ses potes.</p>
        <img src={Watt} alt="" />
      </div>
      <div className="groups">
        <p>Baptiste est le deuxième moteur du projet. C&apos;est celui qui a écrit en entier son film d&apos;action de A à Z avec l&apos;aide de Wyatt, et aussi le créateur de ce site internet.</p>
        <img src={Baptiste} alt="" />
      </div>
      <div className="groups revers">
        <p>Oscar est le compositeur de musique sur tout les projets, il est aussi gros fan de métal et adore créer de la musique. C&apos;est ausi le créateur du projet Dualité !</p>
        <img src={Oscar} alt="" />
      </div>
      <div className="groups">
