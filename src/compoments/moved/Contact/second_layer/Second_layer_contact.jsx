    ...
    <div className="Second_layer_contact">
      ...
      <div className="groups">
        <div className="part" onClick={() => handelClick(1)}>
          <img src={Twitch} alt="" />
          <p>Nous sommes en live sur twitch, vous pouvez communniquer dans le tchat en partagent des idées sérieuses ou pas, sur un projet qui vous tiens à coeur et que vous voulez exploiter.</p>
        </div>
      </div>
      <div className="groups">
